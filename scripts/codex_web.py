...
async function loadWorktrees(j=null){
  ...
  for(let wt of j.worktrees){
    ...
    let acts=ce('div','actions'); acts.appendChild(action('Rename',()=>renameBranch(wt.path,wt.branch||''))); head.appendChild(acts);
    b.appendChild(head);
